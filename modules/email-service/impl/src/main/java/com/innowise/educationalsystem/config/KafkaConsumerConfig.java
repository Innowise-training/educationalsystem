...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, MailRequest> mailRequestConsumerFactory() {
        ...
        props.put(JsonSerializer.TYPE_MAPPINGS, "com.innowise.educationalsystem.course.dto.MailRequest:com.innowise.educationalsystem.dto.MailRequest");
        // The same for everyone else with email sending (TYPE_MAPPINGS) - solve using common module with shared between kafka dtos
        // TODO: Replace with single dto in common module
    ...
    public ConsumerFactory<String, AttemptRequest> attemptRequestConsumerFactory() {
        ...
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(JsonSerializer.TYPE_MAPPINGS, "com.innowise.educationalsystem.course.dto.AttemptRequest:com.innowise.educationalsystem.dto.AttemptRequest");
